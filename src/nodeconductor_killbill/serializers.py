...
class InvoiceSerializer(core_serializers.AugmentedSerializerMixin,
    ...
    pdf = serializers.HyperlinkedIdentityField(view_name='killbill-invoice-pdf', lookup_field='uuid')
    usage_pdf = serializers.HyperlinkedIdentityField(view_name='killbill-invoice-usage-pdf', lookup_field='uuid')
